Project done as part of Python Specialization course on Coursera- https://www.coursera.org/learn/python-project?specialization=python-3-programming. Project uses Optical Character Recognition(Tessaract OCR lib), PIL and OpenCV libraries.
